        ...
        <div class="header-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="cart.html" class="active">Корзина <span class="cart-count" id="header-cart-count"></span></a></li>
                </ul>
            </nav>
...
// Add debug function to cart.html
function debugCartData() {
    console.log("Cart Data:", JSON.parse(localStorage.getItem('cart')));
    console.log("All Products Data:", JSON.parse(localStorage.getItem('allProducts')));
}
debugCartData();
...
function changePage(pageNumber) {
    // Assuming you're storing the current page in a variable
    currentPage = pageNumber;
    // Re-filter/render products with the new page
    filterProducts();
}
